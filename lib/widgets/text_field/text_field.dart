...
class _FxTextFieldState extends State<FxTextField> {
  ...
  Widget build(BuildContext context) {
    ...
    fillColor = fillColor ?? FxAppTheme.theme.inputDecorationTheme.fillColor ?? Colors.transparent;
    ...
    return TextField(
      style: widget.style ?? FxTextStyle.bodyMedium(color: textColor),
      onTap: widget.onTap,
      ...
      decoration: widget.decoration ??
          InputDecoration(
            ...
            labelText: labelText,
            labelStyle: widget.labelStyle ?? FxTextStyle.bodyMedium(color: labelTextColor),
            ...
            hintStyle: widget.hintStyle ?? widget.labelStyle ?? FxTextStyle.bodyMedium(color: labelTextColor),
  ...
  void buildTextFieldStyle() {
    switch (widget.textFieldStyle) {
      case FxTextFieldStyle.underlined:
        filled = filled ?? true;
        fillColor = fillColor ?? FxAppTheme.theme.inputDecorationTheme.fillColor;
        enabledBorder = enabledBorder ??
            UnderlineInputBorder(
              borderSide: BorderSide(
                color: enabledBorderColor ??
                    FxAppTheme.theme.inputDecorationTheme.enabledBorder!.borderSide.color,
              ),
            );
        ...
        focusedBorder = focusedBorder ??
            UnderlineInputBorder(
              borderSide: BorderSide(
                color: focusedBorderColor ?? FxAppTheme.theme.colorScheme.primary,
              ),
            );
        break;
      ...
      case FxTextFieldStyle.outlined:
        ...
        enabledBorder = enabledBorder ??
            OutlineInputBorder(
              borderRadius: BorderRadius.all(Radius.circular(enabledBorderRadius ?? 8)),
              borderSide: BorderSide(
